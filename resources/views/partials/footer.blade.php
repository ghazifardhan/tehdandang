            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 ">
                <div class="ps-widget ps-widget--footer ps-widget--connect">
                    ...
                    <div class="ps-widget__content">
                        ...
                        <p>@2019 Design by<a href="#"> Teh Celup Dandang</a>.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="ps-product-modal ps-product--detail clearfix">
        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 ">
            <div class="ps-product__thumbnail">
                <div class="quickview--main" data-owl-auto="true" data-owl-loop="false" data-owl-speed="10000"
                    ...
                    <div class="ps-product__image"><img src="{{ asset('themes/images/cake/img-cake-12.jpg') }}" alt="">
                    </div>
                    <div class="ps-product__image"><img src="{{ asset('themes/images/cake/img-cake-11.jpg.jpg') }}"
                            alt=""></div>
                    <div class="ps-product__image"><img src="{{ asset('themes/images/cake/img-cake-10.jpg') }}" alt="">
                    </div>
                    <div class="ps-product__image"><img src="{{ asset('themes/images/cake/img-cake-6.jpg') }}" alt="">
                    </div>
                    <div class="ps-product__image"><img src="{{ asset('themes/images/cake/img-cake-5.jpg') }}" alt="">
                    </div>
                </div>
                <div class="quickview--thumbnail" data-owl-auto="true" data-owl-loop="false" data-owl-speed="10000"
                    ...
                    data-owl-nav-right="&lt;i class=&quot;fa fa-angle-right&quot;&gt;&lt;/i&gt;"><img
                        src="{{ asset('themes/images/cake/img-cake-12.jpg') }}" alt=""><img
                        src="{{ asset('themes/images/cake/img-cake-11.jpg') }}" alt=""><img
                        src="{{ asset('themes/images/cake/img-cake-10.jpg') }}" alt=""><img
                        src="{{ asset('themes/images/cake/img-cake-6.jpg') }}" alt=""><img
                        src="{{ asset('themes/images/cake/img-cake-5.jpg') }}" alt=""></div>
            </div>
        </div>
        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 ">
            <header>
                ...
                <div class="ps-product__meta">
                    ...
                    <p class="category"><span>CATEGORIES: </span><a href="product-grid.html">Cupcake</a>,<a
                            ...
                            sweet</a>,<a href="product-grid.html"> bio</a></p>
                </div>
            ...
            <footer><a class="ps-btn--fullwidth ps-btn ps-btn--sm" href="#">Purchase<i
                ...
                <p class="ps-product__sharing">Share with:<a href="#"><i class="fa fa-facebook"></i></a><a href="#"><i
                            class="fa fa-google-plus"></i></a><a href="#"><i class="fa fa-twitter"></i></a></p>
            </footer>
        </div>
    </div>
</div>
